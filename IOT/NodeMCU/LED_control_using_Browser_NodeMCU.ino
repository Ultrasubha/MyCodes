...
const char* ssid = "127 0 0 1"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "nooooo!!!"; // Your Wifi password, in case you have open network comment the whole statement.
 
int ledPin = 14; // GPIO14 or for NodeMCU you can directly write D5 
