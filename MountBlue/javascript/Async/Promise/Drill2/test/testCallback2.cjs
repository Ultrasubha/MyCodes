...
function wrappedGetListsForBoard(id) {
  getListsForBoard(id, listsData)
  .then((listData) => {
...
wrappedGetListsForBoard("abc122dc");
module.exports.wrappedGetListsForBoard = wrappedGetListsForBoard;